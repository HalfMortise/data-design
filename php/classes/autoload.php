...
// does the class use the namespace prefix?
   ...
   /**
    * strncmp: str = string; cmp = comparison; n = character
    * len: length of the string
    * if it does not equal 0, will produce a number
    * if the first 25 are not equal to each other, stop (at return)
    */
...
//substr: sub string (take a string and cut a slice out of it)
